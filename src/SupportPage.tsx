...
export function SupportPage() {
  // Applies the reader's saved light/dark choice when this page is opened directly.
  useTheme();
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black text-black dark:text-white relative flex flex-col items-center py-20 px-6 overflow-x-hidden">
      {/*
